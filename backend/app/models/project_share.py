...
class ProjectShare(Base):
    ...
    allow_feedback: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    allow_ratings: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
